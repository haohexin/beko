...
use App\Models\DeviceCategoryArgument;
...
class DeviceCategoryArgumentController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::form(DeviceCategoryArgument::class, function (Form $form) {
